...
(Print["Int(8th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_+b_.*x_^n_.)^p_/x_,x_Symbol] :=
(Print["Int(13th)@AlgebraicFunctionsOfLinears.m"];
  -(a+b*x^n)^(p+1)/(a*n*(p+1)) +
...
(Print["Int(14th)@AlgebraicFunctionsOfLinears.m"];
  -2*ArcTanh[Sqrt[c+d*x]/Rt[(b*c-a*d)/b,2]]/(b*Rt[(b*c-a*d)/b,2])) /;
FreeQ[{a,b,c,d},x] && PosQ[(b*c-a*d)/b]

(* ::Code:: *)
Int[1/((a_.+b_.*x_)*Sqrt[c_.+d_.*x_]),x_Symbol] :=
(Print["Int(15th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[1/(Sqrt[a_.+b_.*x_]*Sqrt[c_.+d_.*x_]),x_Symbol] :=
(Print["Int(19th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(25th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_.*(c_.+d_.*x_.)^n_,x_Symbol] :=
(Print["Int(26th)@AlgebraicFunctionsOfLinears.m"];
...
(Print["Int(27th)@AlgebraicFunctionsOfLinears.m"];
  (c+d*x)^n/(b*n) +
...
(Print["Int(28th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(29th)@AlgebraicFunctionsOfLinears.m"];
  (a+b*x)^(m+1)*(c+d*x)^n/(b*(m+n+1)) +
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_.*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(30th)@AlgebraicFunctionsOfLinears.m"];
  -(a+b*x)^(m+1)*(c+d*x)^(n+1)/((n+1)*(b*c-a*d)) +
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_.*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(31th)@AlgebraicFunctionsOfLinears.m"];
  -(a+b*x)^(m+1)*(c+d*x)^(n+1)/((n+1)*(b*c-a*d)) +
  Dist[b*(m+n+2)/((n+1)*(b*c-a*d)),Int[(a+b*x)^m*(c+d*x)^(n+1),x]]) /;
...
(Print["Int(32th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(33th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_/(c_+d_.*x_),x_Symbol] :=
(Print["Int(34th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(35th)@AlgebraicFunctionsOfLinears.m"];
  Module[{p=Denominator[m]},
...
(* ::Code:: *)
Int[(a_+b_.*x_)^n_*(c_+d_.*x_)^n_/x_,x_Symbol] :=
(Print["Int(39th)@AlgebraicFunctionsOfLinears.m"];
  (a+b*x)^n*(c+d*x)^n/(2*n) +
...
(* ::Code:: *)
Int[(a_+b_.*x_)^n_*(c_+d_.*x_)^n_/x_,x_Symbol] :=
(Print["Int(40th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_+b_.*x_)^n_*(c_+d_.*x_)^n_/x_,x_Symbol] :=
(Print["Int(41th)@AlgebraicFunctionsOfLinears.m"];
  -(a+b*x)^(n+1)*(c+d*x)^(n+1)/(2*a*c*(n+1)) -
...
(Print["Int(42th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[(a_+b_.*x_)^n_*(c_+d_.*x_)^p_/x_,x_Symbol] :=
(Print["Int(43th)@AlgebraicFunctionsOfLinears.m"];
...
(Print["Int(44th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[x_^m_*(a_.+b_.*x_)^n_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(45th)@AlgebraicFunctionsOfLinears.m"];
  x^(m-1)*(a+b*x)^(n+1)*(c+d*x)^(n+1)/(2*b*d*(n+1)) -
...
(Print["Int(46th)@AlgebraicFunctionsOfLinears.m"];
  (a+b*x)^(n+1)*(c+d*x)^(n+1)/(2*b*d*(n+1))) /;
FreeQ[{a,b,c,d,n},x] && NonzeroQ[n+1] && ZeroQ[a*d+b*c]

(* ::Code:: *)
Int[x_*(a_.+b_.*x_)^n_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(47th)@AlgebraicFunctionsOfLinears.m"];
  (a+b*x)^(n+1)*(c+d*x)^(n+1)/(2*b*d*(n+1)) -
...
(* ::Code:: *)
Int[x_^m_*(a_.+b_.*x_)^n_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(48th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[x_^m_*(a_.+b_.*x_)^n_*(c_.+d_.*x_)^n_,x_Symbol] :=
(Print["Int(49th)@AlgebraicFunctionsOfLinears.m"];
  x^(m-1)*(a+b*x)^(n+1)*(c+d*x)^(n+1)/(b*d*(m+2*n+1)) -
...
(* ::Code:: *)
Int[x_^m_*(a_+b_.*x_)^n_*(c_+d_.*x_)^n_,x_Symbol] :=
(Print["Int(52th)@AlgebraicFunctionsOfLinears.m"];
  x^(m+1)*(a+b*x)^(n+1)*(c+d*x)^(n+1)/(a*c*(m+1)) -
...
(* ::Code:: *)
Int[x_^m_*(a_+b_.*x_)^n_*(c_+d_.*x_)^n_,x_Symbol] :=
(Print["Int(53th)@AlgebraicFunctionsOfLinears.m"];
  x^(m+1)*(a+b*x)^(n+1)*(c+d*x)^(n+1)/(a*c*(m+1)) -
  Dist[(m+n+2)*(a*d+b*c)/(a*c*(m+1)),Int[x^(m+1)*(a+b*x)^n*(c+d*x)^n,x]] -
  Dist[b*d*(m+2*n+3)/(a*c*(m+1)),Int[x^(m+2)*(a+b*x)^n*(c+d*x)^n,x]]) /;
...
(Print["Int(54th)@AlgebraicFunctionsOfLinears.m"];
...
(Print["Int(55th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[x_^m_.*Sqrt[a_+b_.*x_]/Sqrt[c_.+d_.*x_],x_Symbol] :=
(Print["Int(56th)@AlgebraicFunctionsOfLinears.m"];
...
(Print["Int(57th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_)^n_*(c_.+d_.*x_)^p_,x_Symbol] :=
(Print["Int(58th)@AlgebraicFunctionsOfLinears.m"];
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_)^n_*(c_.+d_.*x_)^p_,x_Symbol] :=
(Print["Int(59th)@AlgebraicFunctionsOfLinears.m"];
