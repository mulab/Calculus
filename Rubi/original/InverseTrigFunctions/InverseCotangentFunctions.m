...
(Print["Int(1th)@InverseCotangentFunctions.m"];
  x*ArcCot[a*x] + Log[1+a^2*x^2]/(2*a)) /;
FreeQ[a,x]

(* ::Code:: *)
Int[ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(2th)@InverseCotangentFunctions.m"];
  x*ArcCot[a*x]^n +
...
(Print["Int(3th)@InverseCotangentFunctions.m"];
...
(Print["Int(4th)@InverseCotangentFunctions.m"];
...
(Print["Int(5th)@InverseCotangentFunctions.m"];
...
(Print["Int(6th)@InverseCotangentFunctions.m"];
  -ArcCot[a*x]^n/x -
...
(Print["Int(7th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(8th)@InverseCotangentFunctions.m"];
...
(Print["Int(9th)@InverseCotangentFunctions.m"];
...
(Print["Int(10th)@InverseCotangentFunctions.m"];
...
(Print["Int(11th)@InverseCotangentFunctions.m"];
  ArcCot[a*x]^n*Log[2-2*c/(c+d*x)]/c +
  Dist[a*n/c,Int[ArcCot[a*x]^(n-1)*Log[2-2*c/(c+d*x)]/(1+a^2*x^2),x]]) /;
FreeQ[{a,c,d},x] && ZeroQ[a^2*c^2+d^2] && IntegerQ[n] && n>0
...
(Print["Int(12th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*ArcCot[a_.*x_]^n_./(c_+d_.*x_),x_Symbol] :=
(Print["Int(13th)@InverseCotangentFunctions.m"];
...
(Print["Int(17th)@InverseCotangentFunctions.m"];
...
(Print["Int(18th)@InverseCotangentFunctions.m"];
  I*ArcCot[a*x]^(n+1)/(c*(n+1)) +
  Dist[I/c,Int[ArcCot[a*x]^n/(x*(I+a*x)),x]]) /;
FreeQ[{a,c,d},x] && ZeroQ[d-a^2*c] && RationalQ[n] && n>0
...
(Print["Int(19th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*ArcCot[a_.*x_]^n_./(c_+d_.*x_^2),x_Symbol] :=
(Print["Int(20th)@InverseCotangentFunctions.m"];
  Dist[1/c,Int[x^m*ArcCot[a*x]^n,x]] -
...
(* ::Code:: *)
Int[x_^m_.*ArcCot[a_.*x_]^n_/(c_+d_.*x_^2),x_Symbol] :=
(Print["Int(21th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_.*ArcCot[a_.*x_]^n_/(c_+d_.*x_^2),x_Symbol] :=
(Print["Int(22th)@InverseCotangentFunctions.m"];
...
(Print["Int(23th)@InverseCotangentFunctions.m"];
...
(Print["Int(24th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[ArcCot[a_.*x_]^n_.*Log[u_]/(c_+d_.*x_^2),x_Symbol] :=
(Print["Int(25th)@InverseCotangentFunctions.m"];
  -I*ArcCot[a*x]^n*PolyLog[2,1-u]/(2*a*c) -
  Dist[n*I/2,Int[ArcCot[a*x]^(n-1)*PolyLog[2,1-u]/(c+d*x^2),x]]) /;
FreeQ[{a,c,d},x] && ZeroQ[d-a^2*c] && RationalQ[n] && n>0 && ZeroQ[(1-u)^2-(1-2*I/(I-a*x))^2]
...
(Print["Int(26th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[ArcCot[a_.*x_]^n_.*PolyLog[p_,u_]/(c_+d_.*x_^2),x_Symbol] :=
(Print["Int(27th)@InverseCotangentFunctions.m"];
  I*ArcCot[a*x]^n*PolyLog[p+1,u]/(2*a*c) +
  Dist[n*I/2,Int[ArcCot[a*x]^(n-1)*PolyLog[p+1,u]/(c+d*x^2),x]]) /;
FreeQ[{a,c,d,p},x] && ZeroQ[d-a^2*c] && RationalQ[n] && n>0 && ZeroQ[u^2-(1-2*I/(I-a*x))^2]
...
(Print["Int(28th)@InverseCotangentFunctions.m"];
...
(Print["Int(29th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[ArcCot[a_.*x_]/Sqrt[c_+d_.*x_^2],x_Symbol] :=
(Print["Int(30th)@InverseCotangentFunctions.m"];
...
(Print["Int(31th)@InverseCotangentFunctions.m"];
  -1/(a*c*Sqrt[c+d*x^2]) +
...
(Print["Int(32th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[ArcCot[a_.*x_]^n_/(c_+d_.*x_^2)^(3/2),x_Symbol] :=
(Print["Int(33th)@InverseCotangentFunctions.m"];
...
(Print["Int(34th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[(c_+d_.*x_^2)^m_*ArcCot[a_.*x_],x_Symbol] :=
(Print["Int(35th)@InverseCotangentFunctions.m"];
...
(Print["Int(36th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[(c_+d_.*x_^2)^m_*ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(37th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[(c_+d_.*x_^2)^m_*ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(38th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
(* Int[(c_+d_.*x_^2)^m_*ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(39th)@InverseCotangentFunctions.m"];
...
(Print["Int(40th)@InverseCotangentFunctions.m"];
...
(Print["Int(41th)@InverseCotangentFunctions.m"];
...
(Print["Int(42th)@InverseCotangentFunctions.m"];
...
(Print["Int(43th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*(c_+d_.*x_^2)^p_.*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(44th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*(c_+d_.*x_^2)^p_*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(45th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*(c_+d_.*x_^2)^p_*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(46th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_*(c_+d_.*x_^2)^p_.*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(47th)@InverseCotangentFunctions.m"];
  x^(m+1)*(c+d*x^2)^(p+1)*ArcCot[a*x]^n/(c*(m+1)) +
  Dist[a*n/(m+1),Int[x^(m+1)*(c+d*x^2)^p*ArcCot[a*x]^(n-1),x]] -
...
(* ::Code:: *)
Int[x_^m_.*(c_+d_.*x_^2)^p_.*ArcCot[a_.*x_]^n_.,x_Symbol] :=
(Print["Int(48th)@InverseCotangentFunctions.m"];
  -x^m*(c+d*x^2)^(p+1)*ArcCot[a*x]^(n+1)/(a*c*(n+1)) +
  Dist[m/(a*(n+1)),Int[x^(m-1)*(c+d*x^2)^p*ArcCot[a*x]^(n+1),x]] +
...
(Print["Int(49th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
Int[x_^m_.*(c_+d_.*x_^2)^p_*ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(50th)@InverseCotangentFunctions.m"];
...
(* ::Code:: *)
(* Int[x_^m_.*(c_+d_.*x_^2)^p_*ArcCot[a_.*x_]^n_,x_Symbol] :=
(Print["Int(51th)@InverseCotangentFunctions.m"];
...
(Print["Int(52th)@InverseCotangentFunctions.m"];
  (a+b*x)*ArcCot[a+b*x]/b + Log[1+(a+b*x)^2]/(2*b)) /;
FreeQ[{a,b},x]

(* ::Code:: *)
Int[ArcCot[a_+b_.*x_^n_],x_Symbol] :=
(Print["Int(53th)@InverseCotangentFunctions.m"];
  x*ArcCot[a+b*x^n] +
...
(Print["Int(54th)@InverseCotangentFunctions.m"];
...
(Print["Int(55th)@InverseCotangentFunctions.m"];
...
(Print["Int(59th)@InverseCotangentFunctions.m"];
...
(Print["Int(60th)@InverseCotangentFunctions.m"];
...
(Print["Int(61th)@InverseCotangentFunctions.m"];
...
Int[u_*v_^n_.,x_Symbol] :=
(Print["Int(62th)@InverseCotangentFunctions.m"];
  Module[{tmp=InverseFunctionOfLinear[u,x]},
  Dist[-(-Discriminant[v,x]/(4*Coefficient[v,x,2]))^n/Coefficient[tmp[[1]],x,1],
	Subst[Int[Regularize[SubstForInverseFunction[u,tmp,x]*Csc[x]^(2*(n+1)),x],x], x, tmp]] /;
 NotFalseQ[tmp] && Head[tmp]===ArcCot && ZeroQ[Discriminant[v,x]*tmp[[1]]^2+D[v,x]^2]]) /;
...
(Print["Int(63th)@InverseCotangentFunctions.m"];
...
(Print["Int(64th)@InverseCotangentFunctions.m"];
...
(Print["Int(65th)@InverseCotangentFunctions.m"];
  x*ArcCot[u] +
...
(Print["Int(66th)@InverseCotangentFunctions.m"];
  x^(m+1)*ArcCot[u]/(m+1) +
...
(Print["Int(67th)@InverseCotangentFunctions.m"];
