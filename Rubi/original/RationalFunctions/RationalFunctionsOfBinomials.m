...
(Print["Int(1th)@RationalFunctionsOfBinomials.m"];
  Rt[a/b,2]/a*ArcTan[x/Rt[a/b,2]]) /;
FreeQ[{a,b},x] && PosQ[a/b]

(* ::Code:: *)
Int[1/(a_+b_.*x_^2),x_Symbol] :=
(Print["Int(2th)@RationalFunctionsOfBinomials.m"];
  Rt[-a/b,2]/a*ArcTanh[x/Rt[-a/b,2]]) /;
FreeQ[{a,b},x] && NegQ[a/b]

(* ::Code:: *)
Int[1/(a_+b_.*x_^3),x_Symbol] :=
(Print["Int(3th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^3),x_Symbol] :=
(Print["Int(4th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,3]], s=Denominator[Rt[-a/b,3]]},
  Dist[r/(3*a),Int[1/(r-s*x),x]] +
  Dist[r/(3*a),Int[(2*r+s*x)/(r^2+r*s*x+s^2*x^2),x]]]) /;
FreeQ[{a,b},x] && NegQ[a/b]
...
(Print["Int(5th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(6th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(7th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(8th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,n/2]], s=Denominator[Rt[-a/b,n/2]]},
  Dist[2*r/(a*n),Int[1/(r-s*x^2),x]] +
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(9th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[1/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(10th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,n]], s=Denominator[Rt[-a/b,n]]},
  Int[r/(a*n*(r-s*x)) +
	Sum[2*r*(r+s*Cos[(2*k-1)*Pi/n]*x)/(a*n*(r^2+2*r*s*Cos[(2*k-1)*Pi/n]*x+s^2*x^2)),
      {k,1,(n-1)/2}],x]]) /;
...
(Print["Int(11th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[a/b,3]], s=Denominator[Rt[a/b,3]]},
...
(* ::Code:: *)
Int[x_/(a_+b_.*x_^3),x_Symbol] :=
(Print["Int(12th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,3]], s=Denominator[Rt[-a/b,3]]},
  Dist[r^2/(3*a*s),Int[1/(r-s*x),x]] -
  Dist[r^2/(3*a*s),Int[(r-s*x)/(r^2+r*s*x+s^2*x^2),x]]]) /;
FreeQ[{a,b},x] && NegQ[a/b]
...
(Print["Int(13th)@RationalFunctionsOfBinomials.m"];
  Module[{g=GCD[m+1,n]},
...
(* ::Code:: *)
Int[x_^m_/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(14th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[a/b,4]], s=Denominator[Rt[a/b,4]]},
...
(* ::Code:: *)
Int[x_^m_/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(15th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,2]], s=Denominator[Rt[-a/b,2]]},
...
(* ::Code:: *)
Int[x_^m_./(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(16th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[a/b,n/2]], s=Denominator[Rt[a/b,n/2]]},
...
(* ::Code:: *)
Int[x_^m_./(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(17th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,n/2]], s=Denominator[Rt[-a/b,n/2]]},
  Dist[2*r^(m/2+1)/(a*n*s^(m/2)),Int[1/(r-s*x^2),x]] +
  Dist[4*r^(m/2+1)/(a*n*s^(m/2)),
...
(* ::Code:: *)
Int[x_^m_./(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(18th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[a/b,n]], s=Denominator[Rt[a/b,n]]},
...
(* ::Code:: *)
Int[x_^m_./(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(19th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,n]], s=Denominator[Rt[-a/b,n]]},
  Int[r^(m+1)/(a*n*s^m*(r-s*x)) -
    Sum[2*(-r)^(m+1)*(r*Cos[(2*k-1)*m*Pi/n]+s*Cos[(2*k-1)*(m+1)*Pi/n]*x)/
      (a*n*s^m*(r^2+2*r*s*Cos[(2*k-1)*Pi/n]*x+s^2*x^2)),{k,1,(n-1)/2}],x]]) /;
...
(Print["Int(20th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[a/b,4]], s=Denominator[Rt[a/b,4]]},
  Dist[r/(2*Sqrt[2]*a*s),
...
(* ::Code:: *)
Int[(c_.+d_.*x_^m_)/(a_+b_.*x_^n_),x_Symbol] :=
(Print["Int(21th)@RationalFunctionsOfBinomials.m"];
  Module[{r=Numerator[Rt[-a/b,2]], s=Denominator[Rt[-a/b,2]]},
...
(Print["Int(22th)@RationalFunctionsOfBinomials.m"];
  x*(a+b*x^n)^(p+1)/a) /;
FreeQ[{a,b,n,p},x] && ZeroQ[n*(p+1)+1]

(* ::Code:: *)
Int[(a_+b_.*x_^n_)^p_,x_Symbol] :=
(Print["Int(23th)@RationalFunctionsOfBinomials.m"];
...
(Print["Int(24th)@RationalFunctionsOfBinomials.m"];
  x^(m+1)*(a+b*x^n)^(p+1)/(a*(m+1))) /;
FreeQ[{a,b,m,n,p},x] && ZeroQ[m+n*(p+1)+1] && NonzeroQ[m+1] && NonzeroQ[p+2]

(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_^n_)^p_,x_Symbol] :=
(Print["Int(25th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_^n_)^p_,x_Symbol] :=
(Print["Int(26th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_^n_)^p_,x_Symbol] :=
(Print["Int(27th)@RationalFunctionsOfBinomials.m"];
  x^(m+1)*(a+b*x^n)^(p+1)/(a*(m+1)) -
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_^n_)^p_,x_Symbol] :=
(Print["Int(28th)@RationalFunctionsOfBinomials.m"];
...
(* ::Code:: *)
Int[x_^m_.*(a_+b_.*x_^n_.)^p_.,x_Symbol] :=
(Print["Int(29th)@RationalFunctionsOfBinomials.m"];
...
(Print["Int(30th)@RationalFunctionsOfBinomials.m"];
...
(Print["Int(31th)@RationalFunctionsOfBinomials.m"];
  Int[x^n*(a+b*x^n)^(m-1), x]) /;
FreeQ[{a,b,m,n,p},x] && ZeroQ[n+p]

(* ::Code:: *)
Int[(a_.*x_^p_.+b_.*x_^q_.)^n_,x_Symbol] :=
(Print["Int(32th)@RationalFunctionsOfBinomials.m"];
...
(Print["Int(33th)@RationalFunctionsOfBinomials.m"];
